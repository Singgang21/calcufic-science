        ...
        <section class="sidebar">
          ...
          <?php else: ?>
            ...
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="data_user") { echo "active"; } ?>">
              <a href="./dasboard.php?page=data_user">
                <i class="fa fa-money"></i> <span>Data User</span> 
              </a>
            </li>
            
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="history") { echo "active"; } ?>">
              <a href="./dasboard.php?page=data_history">
                <i class="fa fa-file"></i> <span>Data History</span> 
              </a>
            </li>
            <li class="header">MENU ADMIN</li>
            <li class="<?php if(isset($_GET['page']) && $_GET['page']=="admin") { echo "active"; } ?>">
            <a href="./dasboard.php?page=admin"><i class="fa fa-user text-warning"></i> Managemen User</a></li>
            <li class="treeview">
              <a href="logout.php">
